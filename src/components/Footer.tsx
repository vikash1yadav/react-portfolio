      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center justify-between gap-6 sm:flex-row">
        ...
        <div className="flex flex-wrap items-center gap-6">
          ...
          <button
            ...
            className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-border bg-card text-muted-foreground hover:text-foreground hover:border-primary-accent/40 shadow-xs transition-all focus:outline-hidden"
